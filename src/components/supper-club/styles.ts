...
/* ── Font families ── */
const FONT_DISPLAY = "'Bristol', cursive";           // Elegant script for headings/greetings
const FONT_BODY    = "'Montserrat', sans-serif";     // Clean sans-serif for body
const FONT_ACCENT  = "'Cormorant Garamond', serif";  // Complementary serif for subtitles/labels
